...
n_x = 7 # amount of input units
n_h = 9 # amount of units in the hidden layer number 1
n_h2 = 15 # amount of units in the hidden layer number 2
n_y = 3 # amount of output units
